<h1 align="center">Expandable Text</h1> 

<p align="center">
This app was created to learn more about Android compose creating a Expandable Text component in Jetpack Compose
</p>
...
```bash
git clone https://github.com/munbonecci/ExpandableText.git
```
